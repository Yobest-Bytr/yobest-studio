// Firebase configuration (kept for database, auth removed)
...
const API_KEY = 'AIzaSyChwoHXMqlbmAfeh4lbRUFWx2HjIZ6VV2k'; // Updated as requested, note: may need a valid key
let gamePreviews = [
...
function loadGameDetails() {
    ...
    if (video) {
        ...
        if (video.gamePlay) {
            ...
            tryButton.textContent = 'Try the Game';
            tryButton.className = 'glass-btn btn-magenta';
            tryButton.target = '_blank';
            document.querySelector('.game-details').appendChild(tryButton);
        }
